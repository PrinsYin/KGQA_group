...
class QuestionPaser:
    ...
    def sql_transfer(self, question_type, entities):
        ...
        # 查询疾病的治疗方式
            ...
            sql = ["MATCH (m:Disease)-[r:cure_way]->(n:Cure) where m.name = '{0}' return m.name, r.name, n.name".format(i) for i in entities]
...
if __name__ == '__main__':
    ...
    dic={'args': {'咳嗽': ['disease', 'symptom']}, 'question_types': ['disease_do_food', 'disease_drug']}
    sql = handler.parser_main(dic)
    print(sql)
