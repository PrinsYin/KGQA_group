...
config_path='D:/temp/bert/bert_config_rbt3.json'
checkpoint_path='D:/temp/bert/bert_model.ckpt'
dict_path = 'D:/temp/bert/vocab.txt'
...
if __name__ == '__main__':
    # 加载数据集
    train_data = load_data('bert_data/train.csv')
    test_data = load_data('bert_data/test.csv')
